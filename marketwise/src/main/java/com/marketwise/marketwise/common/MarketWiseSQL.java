...
public class MarketWiseSQL {
  ...
  // Account SQL queries
  public static String GET_ACCOUNTS_BY_SEASON = 
    "SELECT " +
      "id, " +
      "user_id, " +
      "season_id, " +
  ...
  public static String GET_ACCOUNT_BY_USER_AND_SEASON = 
    "SELECT " +
      "id, " +
      "user_id, " +
      "season_id, " +
  ...
  // Season SQL queries
  public static String GET_SEASON_BY_ID = 
    "SELECT " +
      "id, " +
      "name, " +
      "start_date, " +
  ...
  public static String GET_SEASONS = 
    "SELECT " +
      "id, " +
      "name, " +
      "start_date, " +
  ...
  // Trade SQL queries
  public static String GET_TRADES_BY_PORTFOLIO = 
    "SELECT " +
      "id, " +
      "portfolio_id, " +
      "stock_symbol, " +
  ...
  public static String GET_PORTFOLIO_BY_PORTFOLIO = 
    "SELECT " +
      "id, " +
      "user_id, " +
      "cash_balance, " +
  ...
  public static String GET_PORTFOLIO_POSITIONS_BY_PORTFOLIO = 
    "SELECT " +
      "id, " +
      "portfolio_id, " +
      "stock_symbol, " +
  ...
  public static String GET_LEADERBOARD_BY_SEASON = 
    ...
    "LEFT JOIN ( " +
      "SELECT " +
        "portfolio_id, " +
        "SUM(shares * average_price) AS total_value " +
      "FROM portfolio_positions " +
